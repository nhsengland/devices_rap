...
class TestAmberReportPipeline:
    ...
    @pytest.fixture
    def amber_report_pipeline_args(self):
        """
        Fixture to provide arguments for the amber_report_pipeline function.
        """
        return {
            "fin_month": "test",
            "fin_year": "test",
    ...
    def test_calls_functions(self, amber_report_pipeline_args, mock_pipeline_functions, function):
        """
    ...
    def test_calls_config_with_correct_args(
        self, amber_report_pipeline_args, mock_pipeline_functions
    ):
        """
        Test that amber_report_pipeline calls Config with the correct arguments
        """
        pipeline.amber_report_pipeline(**amber_report_pipeline_args)
    ...
    def test_calls_cleanse_master_data_with_correct_args(
        self, amber_report_pipeline_args, mock_pipeline_functions
    ):
        """
    ...
    def test_calls_cleanse_exceptions_with_correct_args(
        self, amber_report_pipeline_args, mock_pipeline_functions
    ):
        """
    ...
    @pytest.mark.parametrize("arg", [0, 1])
    def test_calls_join_device_taxonomy_with_correct_args(
        self, amber_report_pipeline_args, mock_pipeline_functions, arg
    ):
        """
    ...
    @pytest.mark.parametrize("arg", [0, 1])
    def test_calls_join_exceptions_with_correct_args(
        self, amber_report_pipeline_args, mock_pipeline_functions, arg
    ):
        """
    ...
    def test_calls_cleanse_master_joined_dataset_with_correct_args(
        self, amber_report_pipeline_args, mock_pipeline_functions
    ):
        """
    ...
    def test_calls_create_device_summary_table_with_correct_args(
        self, amber_report_pipeline_args, mock_pipeline_functions
    ):
        """
    ...
    def test_calls_join_mini_tables_with_correct_args(
        self, amber_report_pipeline_args, mock_pipeline_functions, call_num, previous_function
    ):
        """
    ...
    def test_calls_join_mini_tables_with_correct_kwargs(
        self,
        amber_report_pipeline_args,
        mock_pipeline_functions,
        kwarg,
        expected_value,
        call_num,
        include_exception_notes,
    ):
        """
    ...
    def test_calls_create_regional_table_cuts_with_correct_tables(
        self, amber_report_pipeline_args, mock_pipeline_functions, table, expected
    ):
        """
    ...
    def test_calls_logger_success_with_correct_message(
        self, amber_report_pipeline_args, mock_log_levels, mock_pipeline_functions
    ):
        """
